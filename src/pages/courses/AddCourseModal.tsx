                ...
                <form onSubmit={handleSubmit(onSubmitHandler)}>
                    <div className="flex flex-col gap-4">
                        ...
                        <div className="grid grid-cols-2 gap-2">
                            <CustomSelect options={categoryOptions} label={""} placeholder={"Select category"} className={"w-full text-sm text-gray-500"} labelName={"Category"} required={true} setSelectedField={setSelectedCategory} />
