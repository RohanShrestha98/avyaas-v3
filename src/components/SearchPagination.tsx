...
export default function SearchPagination({ options, inputPlaceholder, selectPlaceholder }) {
    return (
        <div className="flex items-center justify-between border-t border-l border-r bg-white p-2 px-3 rounded-t-xl">
            <div className="flex items-center gap-2">
                ...
                <CustomSelect className={"w-[220px]"} options={options} label={""} placeholder={selectPlaceholder} />
            </div>
            <Pagination />
        </div>
    )
